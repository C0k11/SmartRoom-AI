...
PLATFORMS = {
    "CA": {  # Canada
        ...
        "platforms": [
            ...
            {"name": "Best Buy Canada", "url": "https://www.bestbuy.ca/en-ca/search?search={query}", "icon": "🖥️"},
    ...
    "US": {  # United States
        ...
        "platforms": [
            ...
            {"name": "Best Buy US", "url": "https://www.bestbuy.com/site/searchpage.jsp?st={query}", "icon": "🖥️"},
